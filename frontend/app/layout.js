import { Instrument_Serif, Inter, Press_Start_2P, Pixelify_Sans, Fredoka } from 'next/font/google'
import './globals.css'
...
export default function RootLayout({ children }) {
  return (
    <html lang="en" className={`${instrumentSerif.variable} ${inter.variable} ${pressStart.variable} ${pixelify.variable} ${fredoka.variable}`}>
