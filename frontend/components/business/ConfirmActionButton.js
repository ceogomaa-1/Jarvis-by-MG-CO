  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 10, paddingTop: 8, paddingBottom: 8 }}>
      ...
      <button
        ...
        style={{
          ...
          background: state === 'holding'
            ? '#c84b31'
            : 'rgba(200,75,49,0.08)',
          color: state === 'holding' ? '#0a0a0a' : '#c84b31',
      ...
      <button
        ...
        onMouseEnter={e => {
          e.currentTarget.style.color = 'rgba(243,234,217,0.6)'
          e.currentTarget.style.borderColor = 'rgba(243,234,217,0.1)'
        }}
        onMouseLeave={e => {
          e.currentTarget.style.color = 'rgba(243,234,217,0.3)'
