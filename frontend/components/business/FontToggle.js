    ...
    <div style={{
      ...
      <button
        ...
        style={{
          ...
          height: 26,
          borderRadius: 999,
          border: `1px solid ${isNormal ? '#ff2e51' : '#3f3f46'}`,
          background: isNormal ? 'rgba(255,46,81,0.25)' : '#141418',
          cursor: 'pointer',
          padding: 0,
      ...
      >
        ...
        <span className="font-pixel" style={{
          ...
          fontSize: 7, lineHeight: 1, color: isNormal ? '#ff2e51' : '#6a6a6a', userSelect: 'none',
        ...
        <motion.div
          ...
          style={{
            ...
            background: isNormal ? '#ff2e51' : '#8b8b94',
            boxShadow: isNormal ? '0 0 10px rgba(255,46,81,0.6)' : 'none',
          }}
        />
      </button>
    </div>
