      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12, marginBottom: 10 }}>
        <motion.div
          ...
          style={{
            ...
            background: 'rgba(255,46,81,0.14)', border: '1px solid rgba(255,46,81,0.4)',
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            fontSize: 11, fontWeight: 700, color: '#ff2e51',
        ...
        <div style={{ flex: 1 }}>
          <p style={{
            margin: 0, fontSize: 14, color: '#f4f4f2',
...
function Sources({ sources }) {
  ...
  return (
    <motion.div
      ...
      style={{ marginTop: 20, paddingTop: 14, borderTop: '1px solid rgba(244,244,242,0.07)' }}
    >
      <div style={{
        fontSize: 9, letterSpacing: '0.18em', textTransform: 'uppercase',
        color: 'rgba(244,244,242,0.3)', fontFamily: 'system-ui, sans-serif', marginBottom: 8,
      }}>
        Sources
      </div>
          ...
          return (
            <a key={i} href={s.url} target="_blank" rel="noopener noreferrer"
              style={{
                ...
                fontSize: 11, color: 'rgba(244,244,242,0.45)',
                textDecoration: 'none', fontFamily: 'system-ui, sans-serif',
              }}
              onMouseEnter={e => e.currentTarget.style.color = 'rgba(244,244,242,0.75)'}
              onMouseLeave={e => e.currentTarget.style.color = 'rgba(244,244,242,0.45)'}
            >
              {hostname && (
                <img
    ...
    <div style={{ marginTop: 4 }}>
      {title && (
        <motion.div
          ...
          style={{
            ...
            color: '#ff2e51', marginBottom: 8, fontWeight: 600,
            fontFamily: 'system-ui, sans-serif',
          }}
        >
          Walkthrough
      ...
      {intro && (
        <motion.p
          ...
          style={{
            fontSize: 13, color: 'rgba(244,244,242,0.65)',
      ...
      {loading && (
        <div style={{ display: 'flex', gap: 5, padding: '8px 0', alignItems: 'center' }}>
          {[0, 1, 2].map(i => (
            <motion.div key={i}
              style={{ width: 6, height: 6, borderRadius: '50%', background: '#ff2e51' }}
              animate={{ scale: [0.8, 1.2, 0.8], opacity: [0.3, 1, 0.3] }}
              transition={{ duration: 1.1, delay: i * 0.18, repeat: Infinity }}
            />
          ))}
          <span style={{
            fontSize: 11, color: 'rgba(244,244,242,0.35)',
