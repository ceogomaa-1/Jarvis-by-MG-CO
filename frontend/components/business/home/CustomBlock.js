...
const editInputStyle = {
  ...inputStyle, background: 'rgba(255,255,255,0.06)', border: '1px solid var(--home-accent-border, rgba(255,46,81,0.3))',
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <div style={{ display: 'flex', gap: 5, padding: '8px 12px', borderTop: '1px solid var(--os1-border-soft, rgba(255,255,255,0.06))' }}>
        ...
        <button onClick={add} disabled={busy} className="os1-iconbtn" title="Add"
          style={{ padding: '5px 8px', border: '1px solid var(--home-accent-border, rgba(255,46,81,0.3))', borderRadius: 7, color: 'var(--home-accent, #5b9bff)' }}>
          <Plus size={14} />
        </button>
      </div>
    </div>
