  ...
  return (
    <button
      ...
      style={{
        ...
        borderRadius: 10,
        border: primary ? '1px solid var(--home-accent-border, rgba(45,127,249,0.35))' : '1px solid var(--os1-border-soft, rgba(255,255,255,0.08))',
        background: primary ? 'var(--home-accent-soft, rgba(45,127,249,0.12))' : 'transparent',
