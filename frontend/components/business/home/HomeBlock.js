  ...
  return (
    <button
      ...
      style={{
        ...
        borderRadius: 10,
        border: primary ? '1px solid rgba(45,127,249,0.35)' : '1px solid var(--os1-border-soft, rgba(255,255,255,0.08))',
        background: primary ? 'rgba(45,127,249,0.12)' : 'transparent',
        color: primary ? '#5b9bff' : 'var(--os1-text-dim, #A8A8A6)',
