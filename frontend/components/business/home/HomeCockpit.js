...
const ACCENT_NAMES = {
  blue: '#ff2e51', emerald: '#34d399', green: '#22c55e', teal: '#14b8a6', purple: '#a855f7',
...
function resolveTheme(theme) {
  ...
  const accent = raw.startsWith('#') ? raw : (ACCENT_NAMES[raw] || '#ff2e51')
  const style = {
    '--home-accent': accent,
      ...
      >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            >
              <span style={{
                ...
                background: settings.default_landing ? '#ff2e51' : 'var(--os1-text-faint, #6E6E6C)',
              }} />
              Default landing
            </button>
        ...
        {suggestion && (
          <div style={{
            ...
            padding: '9px 16px', background: 'rgba(255,46,81,0.08)',
            borderBottom: '1px solid rgba(255,46,81,0.18)', flexShrink: 0,
          }}>
            ...
            <div style={{ display: 'flex', gap: 8, flexShrink: 0 }}>
              <button onClick={() => resolveSuggestion('accept')} className="font-pixel"
                style={{ padding: '5px 11px', borderRadius: 8, fontSize: 10, border: '1px solid rgba(255,46,81,0.4)',
                         background: 'rgba(255,46,81,0.14)', color: '#5b9bff', cursor: 'pointer' }}>
                Apply
              </button>
            ...
            {loading ? (
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '60%', gap: 14, textAlign: 'center' }}>
                ...
                <button onClick={handleRefresh} disabled={refreshing} className="font-pixel"
                  style={{ padding: '9px 16px', borderRadius: 10, fontSize: 11, border: '1px solid rgba(255,46,81,0.35)',
                           background: 'rgba(255,46,81,0.12)', color: '#5b9bff', cursor: 'pointer' }}>
