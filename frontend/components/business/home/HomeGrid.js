...
.jarvis-home-grid .react-grid-item.react-grid-placeholder { background: rgba(255,46,81,0.16); border: 1px dashed rgba(255,46,81,0.45); border-radius: 14px; transition-duration: 100ms; z-index: 2; }
