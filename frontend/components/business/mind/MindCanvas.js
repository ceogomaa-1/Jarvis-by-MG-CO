...
export default function MindCanvas({ userId }) {
  ...
  return (
    <div
      ref={containerRef}
      style={{ position: 'relative', flex: '1 1 auto', minHeight: 0, overflow: 'hidden', background: '#050506' }}
    >
      <canvas
        ref={canvasRef}
      ...
      {!loading && nodeCount === 0 && (
        <div style={{
          ...
          <div style={{
            ...
            color: '#71717a', lineHeight: 2.4, textTransform: 'uppercase',
          }}>
      ...
      <div style={{
        ...
        color: '#71717a', textTransform: 'uppercase', pointerEvents: 'none',
      }}>
      ...
      <div style={{ position: 'absolute', top: 16, right: 16, display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 6 }}>
        <button
          ...
          style={{
            ...
            color: findingSynapses ? '#71717a' : GOLD,
            border: `1px solid ${findingSynapses ? 'rgba(244,244,242,0.12)' : 'rgba(255,210,74,0.4)'}`,
