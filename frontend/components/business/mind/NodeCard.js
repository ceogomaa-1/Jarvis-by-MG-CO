...
function pixelButton({ accent = '#ff2e51', muted = false } = {}) {
  return {
    width: '100%',
    background: muted ? 'transparent' : accent,
    border: muted ? '1px solid rgba(244,244,242,0.18)' : 'none',
    borderRadius: 4,
    padding: '12px 0',
    color: muted ? '#a1a1aa' : (accent === GOLD ? '#050506' : '#ffffff'),
    fontSize: 10,
...
export default function NodeCard({ node, userId, onClose, onForget }) {
  ...
  const accent = isSynapse ? GOLD : isQueue ? '#ff2e51' : colorForCategory(node.mind_category)
    ...
    <AnimatePresence>
      <motion.div
        ...
        style={{
          ...
          borderLeft: `1px solid ${isSynapse ? 'rgba(255,210,74,0.35)' : 'rgba(244,244,242,0.12)'}`,
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', padding: 16 }}>
          <button
            ...
            style={{
              ...
              color: '#f4f4f2', display: 'flex', alignItems: 'center',
            }}
          >
            <X size={14} />
          </button>
        ...
        <div style={{ padding: '0 24px 28px', display: 'flex', flexDirection: 'column', gap: 16, flex: 1 }}>
          ...
          {isSynapse ? (
            <div>
              ...
              <div style={{ fontSize: 10, color: '#71717a', letterSpacing: '0.05em' }}>
            ...
            <div>
              <div style={{
                fontFamily: 'var(--pixel)', fontSize: 11, letterSpacing: '0.2em',
                color: '#f4f4f2', textTransform: 'uppercase', marginBottom: 8,
              }}>
                Knowledge Gap
              </div>
            ...
            <div>
              <div style={{
                fontFamily: 'var(--pixel)', fontSize: 11, letterSpacing: '0.2em',
                color: '#ff2e51', textTransform: 'uppercase', marginBottom: 8,
              }}>
                Morning Queue
              </div>
              <div style={{ fontSize: 10, color: '#ff2e51', letterSpacing: '0.05em' }}>
          ...
          {isSynapse ? (
            <>
              <div style={{ fontSize: 14, color: '#f4f4f2', lineHeight: 1.7 }}>
                {node.insight}
              </div>
            ...
            <>
              ...
              <div>
                <div style={{
                  ...
                  color: '#71717a', textTransform: 'uppercase', marginBottom: 6,
                }}>
                  Strength
                </div>
                <div style={{ height: 4, borderRadius: 2, background: 'rgba(244,244,242,0.08)', overflow: 'hidden' }}>
                  <div style={{
              ...
              {node._related && node._related.length > 0 && (
                <div>
                  <div style={{
                    fontFamily: 'var(--pixel)', fontSize: 9, letterSpacing: '0.2em',
                    color: '#71717a', textTransform: 'uppercase', marginBottom: 8,
                  }}>
                    Related
                  </div>
          ...
          <div style={{ marginTop: 'auto', display: 'flex', flexDirection: 'column', gap: 10, paddingTop: 12 }}>
            ...
            {isGap && (
              <button
                style={pixelButton({ accent: '#ff2e51' })}
                onMouseEnter={e => (e.currentTarget.style.filter = 'brightness(1.1)')}
                onMouseLeave={e => (e.currentTarget.style.filter = 'brightness(1)')}
                onClick={() => goToChat({
                  mode: 'gap',
