      ...
      {agent && (
        <motion.div
          ...
          style={{
            ...
            borderLeft: '1px solid rgba(244,244,242,0.12)',
            zIndex: 50,
        ...
        >
          ...
          <div style={{ padding: '0 24px 24px' }}>
            <div style={{
              ...
              {Icon && <Icon size={28} color="#ff2e51" />}
            </div>

            <div style={{
              fontFamily: 'var(--pixel)',
              fontSize: 14, color: '#f4f4f2',
          ...
          {/* Divider */}
          <div style={{ height: 1, background: 'rgba(244,244,242,0.07)', margin: '0 24px' }} />
            ...
            <>
              ...
              <div style={{ padding: '20px 24px' }}>
                <div style={{
                  ...
                  color: 'rgba(244,244,242,0.4)', textTransform: 'uppercase',
                  marginBottom: 12,
                }}>
                  Recent Activity
                </div>
                {recentActivity.length === 0 ? (
                  <div style={{ fontSize: 12, color: 'rgba(244,244,242,0.3)', lineHeight: 1.6 }}>
                  ...
                  <div
                    ...
                    style={{
                      padding: '10px 0',
                      borderBottom: i < recentActivity.length - 1 ? '1px solid rgba(244,244,242,0.06)' : 'none',
                    }}
                  >
                    <div style={{ fontSize: 10, color: 'rgba(244,244,242,0.35)', marginBottom: 3 }}>
                      {item.time ? (item.time.includes('T') ? relativeTime(item.time) : item.time) : ''}
                    </div>
                    <div style={{ fontSize: 13, color: '#f4f4f2' }}>
                      {item.summary}
                    </div>
                  </div>
                ))}
              ...
              <div style={{ padding: '0 24px 20px' }}>
                ...
                <div style={{
                  ...
                  fontSize: 12,
                  color: lastOutput ? 'rgba(244,244,242,0.7)' : 'rgba(244,244,242,0.3)',
