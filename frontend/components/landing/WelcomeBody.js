...
// Jarvis Personal — redesigned welcome BODY (everything below the painterly hero).
...
<section class="hero"><div class="wrap">
  ...
  <span class="eyebrow reveal">Jarvis &middot; Personal</span>
  <h1 class="display reveal">This is not<br>another <em>chatbot</em>.</h1>
  <p class="herop reveal">Every other AI forgets you the moment you close the tab. Jarvis is one continuous relationship that <b>remembers, learns you, and acts</b> — for real. Try it below. ↓</p>
  <a class="pill solid reveal jpw-cta" href="#">Meet Jarvis</a>
</div></section>
...
<section class="sec"><div class="wrap reveal">
  ...
  <p class="intro">Other AIs start every chat from zero. Jarvis is <em>one</em> conversation that compounds — day after day. Walk through a week and watch the difference.</p>
  <div class="demo"><div class="modeswitch"><button data-m="other">A normal AI</button><button data-m="jarvis" class="on">Jarvis</button></div>
...
<section class="sec"><div class="wrap reveal">
  ...
  <p class="intro">Jarvis quietly notices how you actually work and feel — then adapts. Let it watch a week and see what it picks up.</p>
  <div class="demo"><button class="pill solid" id="watchbtn" style="margin-bottom:18px">Let Jarvis watch a week →</button><div class="insights" id="insights"></div></div>
</div></section>

<section class="sec"><div class="wrap reveal">
  <div class="lab">// study mode</div>
  <h2>Snap it once. Forget it. Jarvis turns it into organized notes.</h2>
  <p class="intro">That photo of the whiteboard rotting in your camera roll? Capture any study material in Jarvis and forget it — it reads the page, writes it up as a real note you can edit, detects the subject, and files it into the right folder for you. You never drown in scattered screenshots again.</p>
  <div class="demo"><div class="flowgrid">
    ...
    <div>
      ...
      <p style="font-family:var(--mono);font-size:11px;color:var(--muted);margin-top:14px;line-height:1.6">Capture three of these and Jarvis builds the whole folder tree itself — no filing, no chaos.</p>
    </div>
  </div>
  <div class="extras">
...
<section class="sec"><div class="wrap reveal">
  ...
  <p class="intro">A warm, human voice with actual tone — wry, calm, encouraging. This is Jarvis's real voice. Press play (and pause whenever you like).</p>
  <div class="demo"><div class="voicecard"><canvas id="wave"></canvas>
    <div><audio id="jaudio" src="/jarvis-voice.mp3" preload="auto"></audio>
    <button class="playbtn" id="playbtn"><svg id="playicon" viewBox="0 0 24 24" fill="currentColor"><path d="M8 5v14l11-7z"/></svg><span id="playlabel">Hear Jarvis</span></button>
...
<div class="cta reveal"><h2>Not a tool.<br>A <em>presence</em>.</h2><p>The first AI that's actually yours.</p><a class="pill solid jpw-cta" href="#">Begin with Jarvis</a></div>
<div class="signoff"><div class="lockup"><span class="dot"><img src="/jarvis-logo-mono.png" alt="Jarvis"></span><span class="jl">Jarvis</span></div><div class="megabrand">MG<span class="amp">&amp;</span>CO<sup>&#8482;</sup></div><div class="tech">Technologies Inc.</div><div class="foot">mgcotechnologies.com <span>&middot;</span> Based in Toronto, Canada <span>&middot;</span> &copy; 2026 MG&amp;CO Technologies Inc.</div></div>
`
  ...
  useEffect(() => {
    ...
    function renderMem() {
      ...
      if (mn) mn.textContent = memMode === 'jarvis'
        ? '↑ Jarvis carries Monday into Friday — one unbroken thread.'
    ...
    if (watchbtn) watchbtn.onclick = function () {
      ...
      setTimeout(() => { watchbtn.textContent = "Jarvis knows you now ✓" }, 500 + INS.length * 700)
    }
    ...
    if (pb && au) {
      ...
      const onPause = () => { speaking = false; pic.innerHTML = PLAY; pl.textContent = 'Hear Jarvis' }
