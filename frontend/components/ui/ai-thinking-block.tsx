  ...
  return (
    <div className={cn("flex w-full max-w-2xl flex-col py-2", className)}>
      <div className="mb-3 flex items-center gap-2.5">
        <span className="flex h-7 w-7 items-center justify-center rounded-full border border-primary/20 bg-primary/10 shadow-[0_0_24px_rgba(45,127,249,0.14)]">
          <Loader size="sm" className="text-[#2d7ff9]" />
        </span>
              ...
              >
                <span
                  className={cn(
                    ...
                    index === 0 ? "bg-[#2d7ff9] shadow-[0_0_10px_rgba(45,127,249,0.7)]" : "bg-white/20",
                  )}
                />
                <span>{line}</span>
              </div>
      ...
      <style jsx>{`
        .ai-thinking-shimmer {
          background-image: linear-gradient(
            110deg,
            rgba(232, 232, 232, 0.32) 25%,
            rgba(255, 255, 255, 0.96) 48%,
            rgba(45, 127, 249, 0.92) 56%,
            rgba(232, 232, 232, 0.32) 78%
          );
